...
<template>
  <div class="basis-1/3 flex flex-col space-y-4">
    <button :disable="() => !active" @click="addBet" class="py-4 font-semibold rounded shadow" :class="{
    ...
    <div
      class="p-2 h-64 overflow-y-hidden space-y-2 bg-white text-left text-xl text-gray-800 rounded shadow shadow-gray-300">
