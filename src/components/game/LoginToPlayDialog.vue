      ...
      >
        ...
        >
          ...
          <p class="text-gray-700">
            For a better experience, please login before placing your bet.
            Keeping track of your wins is more fun, don't worry coins are free !
          </p>

          <RouterLink to="/login" class="block btn-primary w-full text-center">
            Login
          </RouterLink>
        </DialogPanel>
      </TransitionChild>
