<template>
  <main class="py-4 space-y-8">
    <section class="space-y-8">
      ...
      <p>
        These terms and conditions outline the rules and regulations for the use of Roulette's Website, located at
        https://roulette.penfu.net.
      </p>

      <p>
        By accessing this website we assume you accept these terms and conditions. Do not continue to use Roulette if
      ...
      <p>
        ...
        Company's stated services, in accordance with and subject to, prevailing law of af. Any use of the above
    ...
    <section>
      ...
      <p>
        We employ the use of cookies. By accessing Roulette, you agreed to use cookies in agreement with the Roulette's
        Privacy Policy.
      </p>
      <p>
    ...
    <section>
      <h3>License</h3>
      <p>
        Unless otherwise stated, Roulette and/or its licensors own the intellectual property rights for all material on
        Roulette. All intellectual property rights are reserved. You may access this from Roulette for your own personal
        use subjected to restrictions set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Roulette</li>
        <li>Sell, rent or sub-license material from Roulette</li>
        <li>Reproduce, duplicate or copy material from Roulette</li>
        <li>Redistribute content from Roulette</li>
      </ul>
      ...
      <p>
        ...
        areas of the website. Roulette does not filter, edit, publish or review Comments prior to their presence on the
        website. Comments do not reflect the views and opinions of Roulette,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
        applicable laws, Roulette shall not be liable for the Comments or for any liability, damages or expenses caused
        and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this website.
      </p>

      <p>
        Roulette reserves the right to monitor all Comments and to remove any Comments which can be considered
      ...
      <p>
        You hereby grant Roulette a non-exclusive license to use, reproduce, edit and authorize others to use, reproduce
    ...
    <section>
      ...
      <p>
        ...
        records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of Roulette;
      ...
      <p>
        ...
        you must inform us by sending an e-mail to Roulette. Please include your name, your organization name, contact
      ...
      <p>
        No use of Roulette's logo or other artwork will be allowed for linking absent a trademark license agreement.
      </p>
    </section>
